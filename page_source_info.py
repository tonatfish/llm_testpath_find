...
def iterate_nodes(node: ET.Element, object_list, depth=0):
    ...
    if clickable == 'true':
        ...
        obj = {'shape': {'x': bounds[0], 'y': bounds[1], 'width': bounds[2] - bounds[0], 'height': bounds[3] - bounds[1],}, 'text': node_text, 'type': obj_type}
...
def get_page_info(driver: WebDriver, path: str):
    object_list = []
    ...
    for idx, obj in enumerate(object_list):
        draw.rectangle((obj['shape']['x'], obj['shape']['y'], obj['shape']['x'] + obj['shape']['width'], obj['shape']['y'] + obj['shape']['height']), outline=(0, 204, 255), width=5)
        draw.rectangle((obj['shape']['x'], obj['shape']['y'], obj['shape']['x'] + 30, obj['shape']['y'] + 22), fill=(0, 204, 255), outline=(0, 204, 255))
        draw.text((obj['shape']['x'] + 5, obj['shape']['y']), str(idx), fill=(255, 255, 255), font=font, stroke_width=0)
